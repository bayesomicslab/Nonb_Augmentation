...
#   $SNP_AF_BASE/results/mr_notebook_run/
#     NCNR.MirrorRepeats.gnomAD.intersect              (motif x SNP, bedtools -loj)
#     NCNR.MirrorRepeats.gnomAD.shuffled.intersect     (control x SNP)
#     split_counts.txt                                 (N_MOTIF, N_MOTIF_SPACER,
#                                                       N_CTRL,  N_CTRL_SPACER)
#
# Mirror Repeats have 5 sub-parts per locus:
...
#
# Outputs:
#   MirrorRepeats_motif_vs_control_IWTomics_left_0.01.RData
#   MirrorRepeats_motif_vs_control_IWTomics_center_0.01.RData
#   MirrorRepeats_motif_vs_control_IWTomics_right_0.01.RData
...
# paths + parameters
WORKDIR <- file.path(Sys.getenv("SNP_AF_BASE", "/path/to/snp_af_analysis"), "results", "mr_notebook_run")
setwd(WORKDIR)
cat("workdir:", getwd(), "\n")
...
mot <- build_matrices("NCNR.MirrorRepeats.gnomAD.intersect",          N_MOTIF)
ctl <- build_matrices("NCNR.MirrorRepeats.gnomAD.shuffled.intersect", N_CTRL)
...
save(adj_pvalue_curve_left,
     file = "MirrorRepeats_motif_vs_control_IWTomics_left_0.01.RData")
...
save(adj_pvalue_curve_right,
     file = "MirrorRepeats_motif_vs_control_IWTomics_right_0.01.RData")
...
save(adj_pvalue_curve_center,
     file = "MirrorRepeats_motif_vs_control_IWTomics_center_0.01.RData")


# summary
files <- list.files(WORKDIR,
                    pattern = "MirrorRepeats_motif_vs_control_IWTomics.*\\.RData$",
                    full.names = TRUE)
